...
for var str in nonsenseArray{
    newStr.append(str.remove(at: str.index(before: str.endIndex)))
}
print(newStr)
//: __Problem 3__
//:
...
var prices = ["123","240","ab"]
var result = false
func calcPrice(price:[String]) -> Bool{
    for price in prices{
...
print(cleanUp(dWordsArray: dirtyWordsArray))
...
print(archive.filterByDirector(director: "Kathryn Bigelow", movies: movies))
