...
for str in movieTitleArray{

    print(str + " with Puppets")
}
...
for double in oldMountainViewRent{
    var newDouble = double * 1.02
    newMountainViewRent.append(newDouble)
}
...
for (key, value) in  rapperPhoneNumbers{
    let newValue = value.replacingOccurrences(of: "(415)", with: "(510)")
    print(key,newValue)
}
